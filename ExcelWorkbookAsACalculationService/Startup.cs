...
[assembly: OwinStartup(typeof(ExcelWorkbookAsACalculationService.Startup))]

namespace ExcelWorkbookAsACalculationService
{
    public class Startup
    {
        public static string appId = ConfigurationManager.AppSettings["ida:ClientId"];
        public static string appSecret = ConfigurationManager.AppSettings["ida:ClientSecret"];
